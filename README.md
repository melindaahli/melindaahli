...
- 🤝 Involved in WICS community outreach leadership, organizing workshops for K-12 students
- ⚡ Fun Fact: I have a 1300+ day streak on Duolingo learning Chinese, Korean, and Spanish!

### Tech Stack
- **Languages** `TypeScript` `JavaScript` `Python` `C#` `Java` `C++`
- **Frameworks** `React` `Angular` `Node.js` `FastAPI` `ASP.NET Core` `Tailwind CSS`
- **Libraries & Data** `PostgreSQL` `pandas` `NumPy` `Scikit-Learn`
